    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600">Junior Lôbo</span>
                <img class="img-profile rounded-circle" src="https://lastfm.freetls.fastly.net/i/u/avatar170s/35de0dc9cb554ec5ce3f8f48427c6512.webp">
            </a>
            <!-- Dropdown - User Information -->
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="#">
                    <i class="far fa-user fa-fw mr-2 text-gray-500"></i>
                    Profile
                </a>
                <a class="dropdown-item" href="#">
                    <i class="far fa-cogs fa-fw mr-2 text-gray-500"></i>
                    Settings
                </a>
                <a class="dropdown-item" href="#">
                    <i class="far fa-list fa-fw mr-2 text-gray-500"></i>
                    Activity Log
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                    <i class="far fa-sign-out-alt fa-fw mr-2 text-gray-500"></i>
                    Logout
                </a>
            </div>
        </li>
